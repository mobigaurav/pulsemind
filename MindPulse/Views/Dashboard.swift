        ...
        .alert(item: $viewModel.activeAlert) { alertType in
            ...
            case .requestPermission:
                return Alert(
                    ...
                    message: Text("MindPulse would like to access your health data to provide stress and wellness insights."),
            ...
            case .accessDenied:
                return Alert(
                    ...
                    message: Text("You can enable access anytime in Settings → Privacy → Health → MindPulse."),
